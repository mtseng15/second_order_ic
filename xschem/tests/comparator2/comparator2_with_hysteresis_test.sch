...
save all
tran 0.001u 2u
plot Vin_p 0.002*out ref
plot x1.net2
write comparator2_with_hysteresis_test.raw
.endc
"}
...
C {devices/vsource.sym} 450 -250 0 0 {name=V1 value="PULSE -0.002V 0.002V 0 1us 1us 1ns 200us"
}
...
C {src/comparator2/comparator2_10mv_hysteresis.sym} 650 -370 0 0 {name=x1}

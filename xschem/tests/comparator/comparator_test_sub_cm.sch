...
C {devices/vsource.sym} 450 -250 0 0 {name=V1 value="PULSE -1.8V 1.8V 0 200us 1ns 1ns 200us"
}
C {devices/lab_pin.sym} 450 -280 0 0 {name=l2 sig_type=std_logic lab=Vin_p
}
C {devices/lab_pin.sym} 550 -180 0 0 {name=l1 sig_type=std_logic lab=Vin_n
}

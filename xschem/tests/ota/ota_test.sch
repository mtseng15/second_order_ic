...
C {devices/lab_pin.sym} 830 -360 2 0 {name=p5 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 830 -340 2 0 {name=p6 sig_type=std_logic lab=VSS
}
...
C {devices/lab_pin.sym} 840 -380 2 0 {name=p11 sig_type=std_logic lab=out
}
C {devices/noconn.sym} 820 -380 3 0 {name=l5}
C {devices/lab_pin.sym} 840 -400 2 0 {name=p12 sig_type=std_logic lab=diff_out
}
C {devices/noconn.sym} 820 -400 3 0 {name=l6}
C {src/ota/ota.sym} 670 -370 0 0 {name=x1}

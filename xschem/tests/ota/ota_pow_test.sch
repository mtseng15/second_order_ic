...
let pow = i(v1)*v(vdd)
meas tran avg_pow avg pow from=0s to=300us
...
C {devices/vsource.sym} 620 -220 0 0 {name=V3 value="SIN 0 5e-3 10k"
}
...
C {devices/vsource.sym} 620 -140 0 0 {name=V4 value="SIN 0 5e-3 10k"
}

...
C {devices/lab_pin.sym} 210 -530 2 1 {name=p5 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 210 -550 2 1 {name=p6 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 210 -180 0 0 {name=p7 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 210 -160 0 0 {name=p8 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 530 -410 2 0 {name=p9 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 530 -430 2 0 {name=p10 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 530 -300 2 0 {name=p11 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 530 -320 2 0 {name=p12 sig_type=std_logic lab=VSS
}
...
C {devices/lab_pin.sym} 820 -460 2 1 {name=p21 sig_type=std_logic lab=dv2
}
...
C {devices/lab_pin.sym} 1290 -740 0 1 {name=p28 sig_type=std_logic lab=s2
}
...
C {src/ota2/ota2.sym} 370 -530 2 0 {name=x1}
C {src/ota2/ota2.sym} 370 -180 0 1 {name=x11}
C {src/ota2/ota2.sym} 370 -300 2 1 {name=x12}
C {src/ota2/ota2.sym} 370 -410 2 1 {name=x13}
C {devices/vsource.sym} 500 -660 0 0 {name=V1 value=0.3
}
C {devices/lab_pin.sym} 490 -710 2 1 {name=p39 sig_type=std_logic lab=s
}
C {devices/lab_pin.sym} 520 -600 0 1 {name=p40 sig_type=std_logic lab=VRef
}
